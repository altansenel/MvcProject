...
public class BankController extends BaseController<Bank> implements Serializable{
...
setMessage("Bank with id: " + getEntityList().get(row).getId()
...
setEntity(this.bankService.getEntityById(getEntityList().get(row).getId()));
return "bank?faces-redirect=true&entityId=" + getEntityList().get(row).getId();
}
...
public IBankService getPersonService() {
return bankService;
}
