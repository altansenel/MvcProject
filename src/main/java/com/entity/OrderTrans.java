...
/**
 * Persistent class for entity stored in table "order_trans"
 *
...
public class OrderTrans extends BaseEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
//	@EmbeddedId
//   private OrderTransKey compositePrimaryKey ;
    ...
    private Integer    contactTransId ;    @Column(name="waybill_id")
    private Integer    waybillId    ;    @Column(name="invoice_id")
    ...
    @OneToMany(mappedBy="orderTrans", targetEntity=OrderTransFactor.class)
    ...
    @OneToMany(mappedBy="orderTrans", targetEntity=OrderTransDetail.class)
    ...
    //--- DATABASE MAPPING : waybill_id ( INT ) 
