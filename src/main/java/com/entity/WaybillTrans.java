/*
 * Created on 7 Mar 2016 ( Time 11:05:44 )
...
/**
 * Persistent class for entity stored in table "waybill_trans"
 *
...
@Table(name = "waybill_trans")
@org.hibernate.annotations.Cache(usage = org.hibernate.annotations.CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class WaybillTrans extends BaseEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
//	@EmbeddedId
//   private WaybillTransKey compositePrimaryKey ;
    ...
    private Double     minusFactorTotal ;    @Column(name="description", length=100)
    ...
    private Double     excEquivalent ;    @Column(name="is_transfer")
    private Boolean    isTransfer   ;    @Column(name="insert_by", length=20)
    ...
    private Integer    contactTransId ;    @Column(name="invoice_id")
    private Integer    invoiceId    ;    @Column(name="ref_module", length=10)
    ...
    @OneToMany(mappedBy="waybillTrans", targetEntity=WaybillTransFactor.class)
    private List<WaybillTransFactor> listOfWaybillTransFactor;

    @OneToMany(mappedBy="waybillTrans", targetEntity=WaybillTransDetail.class)
    ...
    @OneToMany(mappedBy="waybillTrans", targetEntity=WaybillTransRelation.class)
    private List<WaybillTransRelation> listOfWaybillTransRelation;
    ...
    //--- DATABASE MAPPING : invoice_id ( INT ) 
    ...
    public void setListOfWaybillTransRelation( List<WaybillTransRelation> listOfWaybillTransRelation ) {
        this.listOfWaybillTransRelation = listOfWaybillTransRelation;
    }
    public List<WaybillTransRelation> getListOfWaybillTransRelation() {
        return this.listOfWaybillTransRelation;
    }
