...
/**
 * Persistent class for entity stored in table "contact_trans_source"
 *
...
@Table(name = "contact_trans_source")
@org.hibernate.annotations.Cache(usage = org.hibernate.annotations.CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class ContactTransSource extends BaseEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
//	@EmbeddedId
//   private ContactTransSourceKey compositePrimaryKey ;
    ...
    //----------------------------------------------------------------------
    @OneToMany(mappedBy="contactTransSource", targetEntity=ContactTrans.class)
