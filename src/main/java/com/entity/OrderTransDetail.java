...
/**
 * Persistent class for entity stored in table "order_trans_detail"
 *
...
@Table(name = "order_trans_detail")
@org.hibernate.annotations.Cache(usage = org.hibernate.annotations.CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class OrderTransDetail extends BaseEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
//	@EmbeddedId
//   private OrderTransDetailKey compositePrimaryKey ;
    ...
    private OrderTransSource orderTransSource;
    ...
    public void setOrderTransSource( OrderTransSource orderTransSource ) {
        this.orderTransSource = orderTransSource;
    }
    public OrderTransSource getOrderTransSource() {
        return this.orderTransSource;
    }
