...
/**
 * Persistent class for entity stored in table "safe_trans"
 *
...
@Table(name = "safe_trans")
@org.hibernate.annotations.Cache(usage = org.hibernate.annotations.CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class SafeTrans extends BaseEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
//	@EmbeddedId
//   private SafeTransKey compositePrimaryKey ;
    ...
    private SafeExpense safeExpense ;
    ...
    public void setSafeExpense( SafeExpense safeExpense ) {
        this.safeExpense = safeExpense;
    }
    public SafeExpense getSafeExpense() {
        return this.safeExpense;
    }
    ...
    public void setSafeTransSource( SafeTransSource safeTransSource ) {
        this.safeTransSource = safeTransSource;
    }
    public SafeTransSource getSafeTransSource() {
        return this.safeTransSource;
    }
