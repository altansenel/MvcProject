...
/**
 * Persistent class for entity stored in table "invoice_trans_source"
 *
...
@Table(name = "invoice_trans_source")
@org.hibernate.annotations.Cache(usage = org.hibernate.annotations.CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class InvoiceTransSource extends BaseEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
//	@EmbeddedId
//   private InvoiceTransSourceKey compositePrimaryKey ;
    ...
    private Boolean    hasCostEffect ;    @Column(name="has_stock_effect")
    private Boolean    hasStockEffect ;    @Column(name="insert_by", length=20)
    ...
    //----------------------------------------------------------------------
    @OneToMany(mappedBy="invoiceTransSource", targetEntity=InvoiceTrans.class)
    private List<InvoiceTrans> listOfInvoiceTrans;

    @OneToMany(mappedBy="invoiceTransSource", targetEntity=InvoiceTransDetail.class)
    ...
    //--- DATABASE MAPPING : has_stock_effect ( BIT ) 
    public void setHasStockEffect( Boolean hasStockEffect ) {
        this.hasStockEffect = hasStockEffect;
    }
    public Boolean getHasStockEffect() {
        return this.hasStockEffect;
    }
