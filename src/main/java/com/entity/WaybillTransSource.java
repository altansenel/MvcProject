...
/**
 * Persistent class for entity stored in table "waybill_trans_source"
 *
...
@Table(name = "waybill_trans_source")
@org.hibernate.annotations.Cache(usage = org.hibernate.annotations.CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class WaybillTransSource extends BaseEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
//	@EmbeddedId
//   private WaybillTransSourceKey compositePrimaryKey ;
    ...
    //----------------------------------------------------------------------
    @OneToMany(mappedBy="waybillTransSource", targetEntity=WaybillTrans.class)
    private List<WaybillTrans> listOfWaybillTrans;

    @OneToMany(mappedBy="waybillTransSource", targetEntity=WaybillTransDetail.class)
