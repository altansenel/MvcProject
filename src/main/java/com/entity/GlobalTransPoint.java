...
/**
 * Persistent class for entity stored in table "global_trans_point"
 *
...
@Table(name = "global_trans_point")
@org.hibernate.annotations.Cache(usage = org.hibernate.annotations.CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class GlobalTransPoint extends BaseEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
//	@EmbeddedId
//   private GlobalTransPointKey compositePrimaryKey ;
    ...
    //----------------------------------------------------------------------
    @OneToMany(mappedBy="globalTransPoint", targetEntity=ChqbllPayrollDetail.class)
    private List<ChqbllPayrollDetail> listOfChqbllPayrollDetail;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=OrderTransDetail.class)
    private List<OrderTransDetail> listOfOrderTransDetail;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=StockCosting.class)
    private List<StockCosting> listOfStockCosting;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=InvoiceTrans.class)
    private List<InvoiceTrans> listOfInvoiceTrans;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=StockTransDetail.class)
    private List<StockTransDetail> listOfStockTransDetail;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=ChqbllPayroll.class)
    private List<ChqbllPayroll> listOfChqbllPayroll;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=ContactTrans.class)
    private List<ContactTrans> listOfContactTrans;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=OrderTrans.class)
    private List<OrderTrans> listOfOrderTrans;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=ChqbllTrans.class)
    private List<ChqbllTrans> listOfChqbllTrans;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=InvoiceTransDetail.class)
    private List<InvoiceTransDetail> listOfInvoiceTransDetail;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=BankTrans.class)
    private List<BankTrans> listOfBankTrans;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=StockTrans.class)
    private List<StockTrans> listOfStockTrans;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=WaybillTrans.class)
    private List<WaybillTrans> listOfWaybillTrans;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=WaybillTransDetail.class)
    private List<WaybillTransDetail> listOfWaybillTransDetail;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=SafeTrans.class)
