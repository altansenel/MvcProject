/*
 * Created on 7 Mar 2016 ( Time 11:05:46 )
...
/**
 * Persistent class for entity stored in table "waybill_trans_detail"
 *
...
@Table(name = "waybill_trans_detail")
@org.hibernate.annotations.Cache(usage = org.hibernate.annotations.CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class WaybillTransDetail extends BaseEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
//	@EmbeddedId
//   private WaybillTransDetailKey compositePrimaryKey ;
    ...
    private Date       transDate    ;    @Temporal(TemporalType.DATE)
    @Column(name="delivery_date")
    private Date       deliveryDate ;    @Column(name="trans_type", nullable=false, length=6)
    private String     transType    ;    @Column(name="row_no")
    private Integer    rowNo        ;    @Column(name="name", length=100)
    private String     name         ;    @Column(name="quantity")
    private Double     quantity     ;    @Column(name="unit", length=6)
    private String     unit         ;    @Column(name="unit_ratio")
    private Double     unitRatio    ;    @Column(name="base_price")
    private Double     basePrice    ;    @Column(name="price")
    private Double     price        ;    @Column(name="tax_rate")
    private Double     taxRate      ;    @Column(name="discount_rate1")
    private Double     discountRate1 ;    @Column(name="discount_rate2")
    private Double     discountRate2 ;    @Column(name="discount_rate3")
    private Double     discountRate3 ;    @Column(name="amount")
    private Double     amount       ;    @Column(name="tax_amount")
    private Double     taxAmount    ;    @Column(name="discount_amount")
    private Double     discountAmount ;    @Column(name="total")
    private Double     total        ;    @Column(name="description", length=100)
    private String     description  ;    @Column(name="trans_year")
    private Integer    transYear    ;    @Column(name="trans_month", length=7)
    private String     transMonth   ;    @Column(name="unit1", length=6)
    ...
    private Double     unit3ratio   ;    @Column(name="exc_code", length=3)
    private String     excCode      ;    @Column(name="exc_rate")
    private Double     excRate      ;    @Column(name="exc_equivalent")
    private Double     excEquivalent ;    @Column(name="plus_factor_amount")
    private Double     plusFactorAmount ;    @Column(name="minus_factor_amount")
    private Double     minusFactorAmount ;    @Column(name="input")
    private Double     input        ;    @Column(name="output")
    private Double     output       ;    @Column(name="in_total")
    private Double     inTotal      ;    @Column(name="out_total")
    private Double     outTotal     ;    @Column(name="net_input")
    private Double     netInput     ;    @Column(name="net_output")
    private Double     netOutput    ;    @Column(name="net_in_total")
    private Double     netInTotal   ;    @Column(name="net_out_total")
    private Double     netOutTotal  ;    @Column(name="completed")
    private Double     completed    ;    @Column(name="cancelled")
    private Double     cancelled    ;    @Column(name="is_transfer")
    private Boolean    isTransfer   ;    @Column(name="workspace", nullable=false)
    ...
    private WaybillTransStatus waybillTransStatus;
    ...
    private WaybillTransSource waybillTransSource;
    ...
    //--- DATABASE MAPPING : completed ( DOUBLE ) 
    ...
    //--- DATABASE MAPPING : cancelled ( DOUBLE ) 
    ...
    //--- DATABASE MAPPING : is_transfer ( BIT ) 
    ...
    //----------------------------------------------------------------------
    public void setWaybillTransStatus( WaybillTransStatus waybillTransStatus ) {
        this.waybillTransStatus = waybillTransStatus;
    }
    public WaybillTransStatus getWaybillTransStatus() {
    ...
    public void setWaybillTransSource( WaybillTransSource waybillTransSource ) {
        this.waybillTransSource = waybillTransSource;
    }
    public WaybillTransSource getWaybillTransSource() {
        return this.waybillTransSource;
    }
