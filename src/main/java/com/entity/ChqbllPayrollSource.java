...
@Table(name = "chqbll_payroll_source")
@org.hibernate.annotations.Cache(usage = org.hibernate.annotations.CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class ChqbllPayrollSource extends BaseEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
//	@EmbeddedId
//   private ChqbllPayrollSourceKey compositePrimaryKey ;
    ...
    private String     sort         ;    @Column(name="name", nullable=false, length=30)
    ...
    //----------------------------------------------------------------------
    @OneToMany(mappedBy="chqbllPayrollSource", targetEntity=ChqbllPayrollDetail.class)
    private List<ChqbllPayrollDetail> listOfChqbllPayrollDetail;

    @OneToMany(mappedBy="chqbllPayrollSource", targetEntity=ChqbllPayroll.class)
    private List<ChqbllPayroll> listOfChqbllPayroll;

    @OneToMany(mappedBy="chqbllPayrollSource", targetEntity=ChqbllTrans.class)
