...
@Table(name = "invoice_trans_detail")
@org.hibernate.annotations.Cache(usage = org.hibernate.annotations.CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class InvoiceTransDetail extends BaseEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
//	@EmbeddedId
//   private InvoiceTransDetailKey compositePrimaryKey ;
    ...
    private Boolean    hasCostEffect ;    @Column(name="parent_id")
    private Integer    parentId     ;    @Column(name="parent_right", length=30)
    private String     parentRight  ;    @Column(name="workspace", nullable=false)
