...
public class StockTransDetail extends BaseEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
//	@EmbeddedId
//   private StockTransDetailKey compositePrimaryKey ;
    ...
    private Double     taxRate      ;    @Column(name="tax_rate2")
    private Double     taxRate2     ;    @Column(name="tax_rate3")
    private Double     taxRate3     ;    @Column(name="discount_rate1")
    ...
    private Double     minusFactorAmount ;    @Column(name="serial_no", length=100)
    private String     serialNo     ;    @Column(name="input")
    ...
    private Double     outTotal     ;    @Column(name="is_return")
    private Boolean    isReturn     ;    @Column(name="ret_input")
    private Double     retInput     ;    @Column(name="ret_output")
    private Double     retOutput    ;    @Column(name="ret_in_total")
    private Double     retInTotal   ;    @Column(name="ret_out_total")
    private Double     retOutTotal  ;    @Column(name="net_input")
    ...
    private Double     netOutTotal  ;    @Column(name="has_cost_effect")
    private Boolean    hasCostEffect ;    @Column(name="workspace", nullable=false)
    ...
    private StockTransSource stockTransSource;
    ...
    public void setStockTransSource( StockTransSource stockTransSource ) {
        this.stockTransSource = stockTransSource;
    }
    public StockTransSource getStockTransSource() {
