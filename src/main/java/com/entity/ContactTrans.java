...
/**
 * Persistent class for entity stored in table "contact_trans"
 *
...
@Table(name = "contact_trans")
@org.hibernate.annotations.Cache(usage = org.hibernate.annotations.CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class ContactTrans extends BaseEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
//	@EmbeddedId
//   private ContactTransKey compositePrimaryKey ;
    ...
    private Date       maturity     ;    @Column(name="trans_no", length=20)
    ...
    private ContactTransSource contactTransSource;
    ...
    //--- DATABASE MAPPING : maturity ( DATE ) 
    ...
    //----------------------------------------------------------------------
    public void setContactTransSource( ContactTransSource contactTransSource ) {
        this.contactTransSource = contactTransSource;
    }
    public ContactTransSource getContactTransSource() {
        return this.contactTransSource;
    }
