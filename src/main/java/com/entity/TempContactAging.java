...
@Table(name = "temp_contact_aging")
@org.hibernate.annotations.Cache(usage = org.hibernate.annotations.CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class TempContactAging extends BaseEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
//	@EmbeddedId
//   private TempContactAgingKey compositePrimaryKey ;
    ...
    private String     username     ;    @Column(name="contact_name", length=100)
    private String     contactName  ;    @Column(name="receipt_no")
    ...
    private String     transNo      ;    @Column(name="amount")
    private Double     amount       ;    @Column(name="paid")
    private Double     paid         ;    @Column(name="remain")
    private Double     remain       ;    @Column(name="exc_code", length=3)
    private String     excCode      ;    @Column(name="description", length=100)
