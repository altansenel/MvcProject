...
@Table(name = "chqbll_payroll")
@org.hibernate.annotations.Cache(usage = org.hibernate.annotations.CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class ChqbllPayroll extends BaseEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
//	@EmbeddedId
//   private ChqbllPayrollKey compositePrimaryKey ;
    ...
    @OneToMany(mappedBy="chqbllPayroll", targetEntity=ChqbllPayrollDetail.class)
