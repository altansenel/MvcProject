...
@Table(name = "chqbll_payroll_detail")
@org.hibernate.annotations.Cache(usage = org.hibernate.annotations.CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class ChqbllPayrollDetail extends BaseEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
//	@EmbeddedId
//   private ChqbllPayrollDetailKey compositePrimaryKey ;
    ...
    private Boolean    isCustomer   ;    @Column(name="portfolio_no", nullable=false)
    private Integer    portfolioNo  ;    @Column(name="row_no", nullable=false)
    private Integer    rowNo        ;    @Column(name="serial_no", length=25)
    private String     serialNo     ;    @Temporal(TemporalType.DATE)
    @Column(name="due_date", nullable=false)
    private Date       dueDate      ;    @Column(name="amount", nullable=false)
    private Double     amount       ;    @Column(name="description", length=100)
    private String     description  ;    @Column(name="due_year")
    private Integer    dueYear      ;    @Column(name="due_month", length=7)
    private String     dueMonth     ;    @Column(name="owner", length=70)
    private String     owner        ;    @Column(name="payment_place", length=30)
    private String     paymentPlace ;    @Column(name="bank_account_no", length=15)
    private String     bankAccountNo ;    @Column(name="bank_name", length=50)
    private String     bankName     ;    @Column(name="bank_branch", length=30)
    private String     bankBranch   ;    @Column(name="correspondent_branch", length=30)
    private String     correspondentBranch ;    @Column(name="contact_name", length=100)
    private String     contactName  ;    @Column(name="last_step", nullable=false, length=15)
    private String     lastStep     ;    @Column(name="last_contact_name", length=100)
    private String     lastContactName ;    @Column(name="surety", length=100)
    private String     surety       ;    @Column(name="surety_address", length=100)
    private String     suretyAddress ;    @Column(name="surety_phone1", length=15)
    private String     suretyPhone1 ;    @Column(name="surety_phone2", length=15)
    private String     suretyPhone2 ;    @Column(name="exc_code", length=3)
    private String     excCode      ;    @Column(name="exc_rate")
    private Double     excRate      ;    @Column(name="exc_equivalent")
    private Double     excEquivalent ;    @Column(name="total_paid")
    private Double     totalPaid    ;    @Column(name="bank_id")
    private Integer    bankId       ;    @Column(name="workspace", nullable=false)
    ...
    //----------------------------------------------------------------------
    @OneToMany(mappedBy="chqbllPayrollDetail", targetEntity=ChqbllTransDetail.class)
    ...
    private ChqbllPayroll chqbllPayroll;

    @ManyToOne
    @JoinColumn(name="contact_id", referencedColumnName="id")
    private Contact contact     ;

    @OneToMany(mappedBy="chqbllPayrollDetail", targetEntity=ChqbllDetailHistory.class)
    private List<ChqbllDetailHistory> listOfChqbllDetailHistory;

    @OneToMany(mappedBy="chqbllPayrollDetail", targetEntity=ChqbllDetailPartial.class)
    ...
    public void setChqbllPayroll( ChqbllPayroll chqbllPayroll ) {
        this.chqbllPayroll = chqbllPayroll;
    }
    public ChqbllPayroll getChqbllPayroll() {
    ...
    public void setChqbllType( ChqbllType chqbllType ) {
        this.chqbllType = chqbllType;
    }
    public ChqbllType getChqbllType() {
