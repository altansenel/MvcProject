...
/**
 * Persistent class for entity stored in table "bank_trans_source"
 *
...
public class BankTransSource extends BaseEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
//	@EmbeddedId
//   private BankTransSourceKey compositePrimaryKey ;
    ...
    //----------------------------------------------------------------------
    @OneToMany(mappedBy="bankTransSource", targetEntity=BankTrans.class)
