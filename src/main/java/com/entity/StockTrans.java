...
/**
 * Persistent class for entity stored in table "stock_trans"
 *
...
public class StockTrans extends BaseEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
//	@EmbeddedId
//   private StockTransKey compositePrimaryKey ;
    ...
    private String     right        ;    @Column(name="is_completed")
    ...
    private Double     minusFactorTotal ;    @Column(name="amount")
	...
	// "refDepotId" (column "ref_depot_id") is not defined by itself because used as FK in a link 
    ...
    @OneToMany(mappedBy="stockTrans", targetEntity=StockTransFactor.class)
    private List<StockTransFactor> listOfStockTransFactor;

    @ManyToOne
    @JoinColumn(name="ref_depot_id", referencedColumnName="id")
    private StockDepot stockDepot2 ;

    @OneToMany(mappedBy="stockTrans", targetEntity=StockTransDetail.class)
    ...
    @OneToMany(mappedBy="stockTrans", targetEntity=StockTransCurrency.class)
    private List<StockTransCurrency> listOfStockTransCurrency;

    @ManyToOne
    @JoinColumn(name="seller_id", referencedColumnName="id")
    private SaleSeller saleSeller  ;

    @OneToMany(mappedBy="stockTrans", targetEntity=StockTransTax.class)
    private List<StockTransTax> listOfStockTransTax;
    ...
    public void setStockDepot2( StockDepot stockDepot2 ) {
        this.stockDepot2 = stockDepot2;
    }
    public StockDepot getStockDepot2() {
        return this.stockDepot2;
    }
    ...
    public void setListOfStockTransCurrency( List<StockTransCurrency> listOfStockTransCurrency ) {
        this.listOfStockTransCurrency = listOfStockTransCurrency;
    }
    public List<StockTransCurrency> getListOfStockTransCurrency() {
        return this.listOfStockTransCurrency;
    }
    ...
    public void setListOfStockTransTax( List<StockTransTax> listOfStockTransTax ) {
        this.listOfStockTransTax = listOfStockTransTax;
    }
    public List<StockTransTax> getListOfStockTransTax() {
        return this.listOfStockTransTax;
    }
