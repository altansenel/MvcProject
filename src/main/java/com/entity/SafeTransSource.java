...
/**
 * Persistent class for entity stored in table "safe_trans_source"
 *
...
@Table(name = "safe_trans_source")
@org.hibernate.annotations.Cache(usage = org.hibernate.annotations.CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class SafeTransSource extends BaseEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
//	@EmbeddedId
//   private SafeTransSourceKey compositePrimaryKey ;
    ...
    //----------------------------------------------------------------------
    @OneToMany(mappedBy="safeTransSource", targetEntity=SafeTrans.class)
