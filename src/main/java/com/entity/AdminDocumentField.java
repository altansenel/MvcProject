...
@Table(name = "admin_document_field")
@org.hibernate.annotations.Cache(usage = org.hibernate.annotations.CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class AdminDocumentField extends BaseEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
//	@EmbeddedId
//   private AdminDocumentFieldKey compositePrimaryKey ;
    ...
    private String     module       ;    @Column(name="band", length=12)
    private String     band         ;    @Column(name="_type", length=20)
    private String     type         ;    @Column(name="name", length=100)
    private String     name         ;    @Column(name="nick_name", length=100)
    private String     nickName     ;    @Column(name="hidden_field", length=100)
    private String     hiddenField  ;    @Column(name="_label", length=70)
    private String     label        ;    @Column(name="original_label", length=70)
    private String     originalLabel ;    @Column(name="label_width")
    private Integer    labelWidth   ;    @Column(name="label_align", length=5)
    private String     labelAlign   ;    @Column(name="_width")
    private Integer    width        ;    @Column(name="_row")
    private Integer    row          ;    @Column(name="_column")
    private Integer    column       ;    @Column(name="_format", length=30)
    private String     format       ;    @Column(name="prefix", length=5)
    private String     prefix       ;    @Column(name="suffix", length=5)
    private String     suffix       ;    @Column(name="_value", length=70)
    private String     value        ;    @Column(name="msg_prefix", length=30)
    private String     msgPrefix    ;    @Column(name="defauld", length=50)
    private String     defauld      ;    @Column(name="is_db_field")
    private Boolean    isDbField    ;    @Column(name="table_type", length=10)
    ...
    private AdminDocument adminDocument4;
    ...
    //----------------------------------------------------------------------
    public void setAdminDocument4( AdminDocument adminDocument4 ) {
        this.adminDocument4 = adminDocument4;
    }
    public AdminDocument getAdminDocument4() {
        return this.adminDocument4;
    }

    public void setAdminDocument( AdminDocument adminDocument ) {
        this.adminDocument = adminDocument;
    }
    public AdminDocument getAdminDocument() {
        return this.adminDocument;
    }

    public void setAdminDocument3( AdminDocument adminDocument3 ) {
        this.adminDocument3 = adminDocument3;
    }
    public AdminDocument getAdminDocument3() {
        return this.adminDocument3;
    }

    public void setAdminDocument5( AdminDocument adminDocument5 ) {
        this.adminDocument5 = adminDocument5;
    }
    public AdminDocument getAdminDocument5() {
        return this.adminDocument5;
    }

    public void setAdminDocument2( AdminDocument adminDocument2 ) {
        this.adminDocument2 = adminDocument2;
    }
    public AdminDocument getAdminDocument2() {
